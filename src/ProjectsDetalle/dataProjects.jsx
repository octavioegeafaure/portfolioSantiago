...
export const items = [
    ...
    description: {
      useBullets: false,
      content: [
        "The project is located on General Paz Street in the city center of Córdoba. Regarding its layout, two volumes were configured: the tower for residential use and the strip for cultural, educational, and recreational purposes. In addition to this, circulation cores for each program and other services were situated along the southern party wall.   ",
        "To establish a direct connection between the public space of the avenue and the inner heart of the block, the tower rises towards the facade, creating a triple-height entrance with a prominent concrete portico.  ",
        "Following this entrance is the cultural center, featuring an exhibition hall on the ground floor and workshops on the upper level. All of these functions are housed within open-plan floors with a cantilevered perimeter circulation, allowing for diverse utilization of the space.  ",
        "The tower has an independent entrance separate from the cultural center, facing the street. From the lobby, access is provided to the free-standing circulation core, which branches into circulation bridges every two levels.     ",
        "The residential units are oriented towards both facades and are duplex in nature, offering the option of 1 or 2 bedrooms. The ground floor accommodates the daytime areas, with the potential for expansion onto the double-height balcony, while the nighttime areas are located on the upper floor. The service areas are clustered in the central module of the tower.   ",
    ...
    { id: 6, 
      ...
      useBullets: true,
      content: [
        "Interdisciplinary fusion gives rise to a distinct language within this proposal, laden with expression and proficiency.", 
        "Spatial sequences are arranged within a continuous space devoid of a defined beginning or end, with arbitrary boundaries and a clear objective: to challenge.",
